...
import { Navbar, Dropdown, Badge, Container, ListGroup, Button } from 'react-bootstrap';
    ...
    const mockNotifications: Notification[] = [
      {
        ...
        message: 'Panne critique détectée dans la région centrale',
        date: 'Il y a 10 min',
        read: false,
        type: 'danger'
      },
      {
        ...
        message: 'Maintenance prévue pour la région nord demain à 02:00',
        date: 'Il y a 2h',
        read: false,
        type: 'warning'
      },
      {
        ...
        message: 'Nouveau technicien assigné à votre département',
        date: 'Il y a 5h',
        read: true,
        type: 'info'
      }
